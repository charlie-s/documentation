...
The template engine is compatible with `handlebarsjs`_ but doesn't support all features (right now not all features of Handlebars 2.0, or even 1.1 is currently implemented).
...
.. _pybars3: https://github.com/wbond/pybars3
.. _handlebarsjs: https://handlebarsjs.com/
